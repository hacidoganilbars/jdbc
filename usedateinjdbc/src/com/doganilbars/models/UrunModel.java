...
public class UrunModel {
	...
	public List<Urun> findByDate(Date from,Date to){
		
		List<Urun> urunler=new ArrayList<Urun>();
		
		try {
			PreparedStatement preparedStatement=VeritabaniBaglantisi.getConnection().prepareStatement("select * from urun where imalatTarihi between ? and ?");
